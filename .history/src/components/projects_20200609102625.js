...
import { Tab, Tabs, Grid, Cell, Card, CardTitle, CardActions, Button , CardMeni, IconButton } from "react-mdl";
    ...
    if (this.state.activeTab === 0) {
      return (
        <Card shadow ={5} style={{minWidth: '450', margin: 'auto'}}>
          <CardTitle style={{color: 'fff', height: '170px', background: 'url() center / cover'}}
